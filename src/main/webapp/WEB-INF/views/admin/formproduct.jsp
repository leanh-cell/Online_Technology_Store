    ...
    <div class="container-user p-4 ml-2 mr-2"
                ...
                <div class="col-sm-8">
                    <div class="row">
                        ...
                        <div class="mb-3 col-sm-12">
                            ...
                            <textarea value="${formProduct.description}" name="description"
                                      id="descriptionInput" class="form-control"
                                      placeholder="Nhập ghi chú (nếu có)" rows="3">${formProduct.description}</textarea>
                        </div>
                    </div>
                    <h4>${message}</h4>
                    <div class="row">
        ...
        <div style="text-align: center;" class="col-sm-4">
            <form action="/admin/delete-product" method="get">
                <input type="hidden" name="id"  value="${formProduct.id}">
