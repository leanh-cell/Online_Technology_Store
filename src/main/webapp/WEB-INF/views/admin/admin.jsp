...
<%--                </li>--%>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="/admin/homeadmin" class="brand-link">
...
<%--                <span class="brand-text font-weight-light">Admin</span>--%>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="../src/main/webapp/css/admin/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Thành Phúc</a>
                    </div>
                </div>
...
<%--                                    <span class="badge badge-info right">6</span>--%>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/admin/list-brand" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Nhà sản xuất</p>
                                    </a>
                                </li>
