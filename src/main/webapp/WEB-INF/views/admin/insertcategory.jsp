...
<div class="col-sm-12 m-auto p-0 m-0">
	<a href="/admin/list-category" class="btn btn-primary ml-5">Quay
		lại</a>
	<div class="container-user p-4 ml-2 mr-2 col-sm-7 m-auto"
		...
		<form onsubmit="return validateForm()" action="/admin/insert-category"
			method="POST" enctype="multipart/form-data" class="m-auto">
			<div class="row">
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-8">
							<div class="col-sm-12">
								<div class="mb-3">
									<label for="exampleInputEmail1" class="form-label">TÊN
										LOẠI SẢN PHẨM <img src="image source"
										class="img-fluid rounded-top" alt="">
									</label> <input id="nameInput" value="${category.name}" name="name"
							...
							<div class="col-sm-12">
								<div class="mb-3">
									<label for="formFile" class="form-label">ẢNH LOẠI SẢN
										PHẨM</label> <input onchange="chooseFile(this)" value=""
						...
						<div class="col-sm-4">
							<div class="col-sm-12">
								<div
									style="background-color: rgb(241, 241, 241); height: 200px;">
									<img id="image"
										style="width: 100%; height: 100%; object-fit: contain;"
										src="/image/${category.img}" alt="">
								</div>
							</div>
						</div>
						<h6>${message}</h6>
