...
<div class="m-auto mt-5 mb-5 "
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="row mb-3">
                <a style="text-decoration: none;color:#CF5763 " class="col" href="/order-waiting">
                ...
                <a style="text-decoration: none;" class="col" href="/order-delivered">
            ...
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${orderX}" var="order">
                    <tr>
                        ...
                        <td><c:choose>
                            ...
                            <c:when test="${order.status == 'H'}"><span
                                    style="color: red; font-style: italic;">Đã hủy</span></c:when>
                        </c:choose></td>
