	...
	<div class="mt-4"
			...
			<div style="display: flex; flex-wrap: wrap;">
				<c:forEach items="${brandByIdCategory}" var="brand">
					<div
						...
						<a
							href="/productbrand?idBrand=${brand.id}&idCategory=${idCategory}"
							...
							href=""> <img src="image/${brand.img}" style="width: 90px;"
							alt="">
						</a>
					</div>
				</c:forEach>
        ...
        <ul class="dropdown-menu p-0" aria-labelledby="dropdownMenuButton1">
            ...
            <input id="min" type="number" class="input-min" value="100"> -->
                            <span class="range-left" style=""> <input type="tel"
                                class="inputmax" maxlength="8" name="price-min"
                                data-minvalue="300000" value="${minPriceRange}"> <label
                    ...
                    <div class="range-input">
                        <input type="range" class="range-min" min="${minPriceRange}" max="${maxPriceRange}"
                            ...
                            <input type="range"
                            class="range-max" min="${minPriceRange}" max="${maxPriceRange}" value="${maxPriceRange}" step="100">
                    </div>
						...
						<div class="accordion" id="accordionPanelsStayOpenExample">
							<div class="accordion-item" style="border-radius: 0px;">
								...
								<div id="panelsStayOpen-collapseOne"
									...
									<div class="accordion-body pt-0 pb-3 pl-5 ">
