                    ...
                    <form class="mb-5" method="post" id="contactForm" name="contactForm" novalidate="novalidate">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" name="phone" id="Phone_number" placeholder="Số điện thoại">
                                <p style="color: red;" id="phone-error" class="error-message"></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <select class="form-select form-select-sm mb-3" name="province" id="city" aria-label=".form-select-sm">
